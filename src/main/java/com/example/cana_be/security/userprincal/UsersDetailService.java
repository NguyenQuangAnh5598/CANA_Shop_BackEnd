package com.example.cana_be.security.userprincal;

import com.example.cana_be.model.User;
import com.example.cana_be.repository.IUserRepo;

import com.example.cana_be.service.implement.UserServiceImpl;
...
public class UsersDetailService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        User user = userRepository.findUserByUsername(username).orElseThrow(()-> new UsernameNotFoundException("User not found -> username or password"+username));
